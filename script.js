...
saveStorageBtn.addEventListener('click', () => {
  localStorage.setItem('savedArray', JSON.stringify(drawnArray));
...
loadStorageBtn.addEventListener('click', () => {
  if (localStorage.getItem('savedArray')) {
    drawnArray = JSON.parse(localStorage.savedArray);
    restoreCanvas();
  // Active Tool
    activeToolEl.textContent = 'Canvas Loaded';
    setTimeout(switchToBrush, 1500);
  } else{
    activeToolEl.textContent = 'Local Storage Empty';
    setTimeout(switchToBrush, 1500);
  }
...
downloadBtn.addEventListener('click', () => {
  ...
  downloadBtn.download="drawn-page.jpeg";
